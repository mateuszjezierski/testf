<?php 
	...
	if(!empty($user['id'])) {
		...
		$db->Query("INSERT INTO `completed_offers` (`user_id`,`survey_id`,`user_country`,`user_ip`,`revenue`,`reward`,`method`,`timestamp`) VALUES ('".$user['id']."','".$offer_id."','".$user['code']."','".$user['log_ip']."','".$payout."','".$amount."','personaly','".time()."')");
	}
