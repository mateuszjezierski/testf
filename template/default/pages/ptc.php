		  ...
		  <div id="grey-box">
			...
			?>
				<div class="website_block" id="<?=$site['id']?>">
					<div class="website_title" title="<?=$site['title']?>"><?=truncate($site['title'], 22)?></div>
					<div class="description"><?=$site['description']?></div>
					<div class="clear"></div>
					<div class="reward"><i class="fa fa-check-circle"></i> <span><?=(number_format($site['reward']).' '.$lang['l_530']); ?></span></div>
					<div class="time" title="<?php echo lang_rep($lang['l_229'], array('-TIME-' => $site['time'])); ?>"><i class="fa fa-clock-o"></i> <span><?=$site['time']; ?></span></div>
