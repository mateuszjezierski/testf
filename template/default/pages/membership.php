...
?>
					...
					<div class="content">
						...
						<div class="row">
							<div class="col-lg-4 col-md-12 padding-0" id="membership">
									...
									<div class="field first"><?php echo $lang['l_543']; ?></div>
							...
							<div class="col-lg-2 col-md-6 padding-0">
								<div id="membership">
									<div class="first_child">
										...
										<div class="price"><?php echo ($pack['price'] == 0 ? '<span class="subprice_big">'.$lang['l_129'].'</span>' : '<span class="subprice">$</span>'.number_format($pack['price'], 2).'<br /><span class="small">'.$lang['l_131'].'</span>'); ?></div>
									</div>
									...
									<div class="field text-center"><b><i class="fa fa-<?php echo ($pack['direct_crypto_manual'] == 1 ? 'check' : 'times'); ?> fa-lg fa-fw" aria-hidden="true"></i></b></div>
									<div class="field text-center"><b><i class="fa fa-<?php echo ($pack['direct_crypto_auto'] == 1 ? 'check' : 'times'); ?> fa-lg fa-fw" aria-hidden="true"></i></b></div>
									<div class="field text-center"><b><?php echo ($pack['withdraw_wait_time'] > 0 ? lang_rep($lang['l_544'], array('-TIME-' => $pack['withdraw_wait_time'])) : $lang['l_545']); ?></b></div>
									<div class="field text-center"><b><?php echo number_format($pack['hash_rate']); ?></b></div>
									<div class="field text-center"><b><?php echo lang_rep($lang['l_546'], array('-TIME-' => $pack['bonus_roll'])); ?></b></div>
        ...
        <form class="form-pricing" role="form" method="post">
          ...
          <div class="price-form">
            ...
            <div class="row form-group">
              ...
              <div class="col-sm-6">
                <p class="result lead" id="discount-label">$0.00</p>
	...
	function update(slider,val) {
		...
		if($duration >= <?php echo $config['months_to_discount']; ?>) {
			$( "#discount-label").text('$'+$discount.toFixed(2));
			$( "#total-label").text('$'+($total - $discount.toFixed(2)).toFixed(2));
