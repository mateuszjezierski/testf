						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6 col-12 mb-3">
								<div class="card text-white bg-secondary ">
								  ...
								  <div class="card-body">
									<p class="card-title text-center"><b><?=number_format($leads['total_offers'])?></b><br /><?=$lang['l_519']?></p>
								  </div>
								</div>
							</div>
							<div class="col-lg-3 col-md-6 col-12 mb-3">
								<div class="card text-white bg-secondary ">
								  ...
								  <div class="card-body">
									<p class="card-title text-center"><b><?=number_format($refs['total'])?></b><br /><?=$lang['l_520']?></p>
								  </div>
								</div>
							</div>
						</div>
