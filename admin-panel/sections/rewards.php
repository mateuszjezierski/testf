		...
		<form action="" method="post" class="box">
			...
			<div class="content">
				...
				<div class="row">
					...
					<div><select name="type"><option value="0">Coins</option><option value="1"<?=($pack['type'] == 1 ? ' selected' : '')?>>Membership Days</option><option value="2"<?=($pack['type'] == 2 ? ' selected' : '')?>>Purchase Balance</option></select></div>
				</div>
				<div class="row">
	...
	<div class="grid_4">
		<form method="post" class="box">
			...
			<div class="content"><?=$message?>
				...
				<div class="row">
					<label><strong>Reward Type</strong></label>
					<div><select name="type"><option value="0">Coins</option><option value="1">Membership Days</option><option value="2">Purchase Balance</option></select></div>
				</div>
				<div class="row">
					<label><strong>Reward</strong></label>
