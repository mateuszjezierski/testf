		...
		<div class="box">
			...
			<div class="content">
				...
				<p><b>3)</b> After you new app is created, on app settings complete <i>Register for S2S Callbacks</i> field with following URL and make sure you check <i>Notify me when the user is not eligible</i>:<br />
					<input type="text" value="<?php echo $config['secure_url']; ?>/system/gateways/pollfish.php?device_id=[[device_id]]&cpa=[[cpa]]&request_uuid=[[request_uuid]]&timestamp=[[timestamp]]&tx_id=[[tx_id]]&signature=[[signature]]&status=[[status]]&reason=[[term_reason]]&reward_name=[[reward_name]]&reward_value=[[reward_value]]&click_id=[[click_id]]" onclick="select()" style="width:100%" />
				</p>
