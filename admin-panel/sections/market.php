	...
	<div class="grid_4">
		...
		<form action="" method="post" class="box">
			<div class="header">
				...
				<div class="content">
					<div class="row">
						<label><strong>Referral Price</strong><small>Price with up to 2 decimals</small></label>
						<div><input type="text" name="set[market_price]" value="<?=$config['market_price']?>" placeholder="0.50" required="required" /></div>
					</div>
					<div class="row">
