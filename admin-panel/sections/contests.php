	...
	<div class="grid_6">
		<form method="post" class="box">
			...
			<div class="content">
				...
				<div class="row">
					<label><strong>Ticket Price</strong><small>Price in Coins for each lottery ticket</small></label>
					<div><input type="text" name="set[lottery_price]" value="<?=$config['lottery_price']?>" required /></div>
				</div>
				<div class="row">
					<label><strong>Ticket Fee</strong><small>Coins deducted from each purchased ticket.<br />Difference goes to lottery prize, if set to <i>Dynamic Reward</i></small></label>
