...
<section id="content" class="container_12"><?=$message?>
	<div class="grid_6">
		<form method="post" enctype="multipart/form-data" class="box">
			...
			<div class="content">
				<div class="row">
					<label><strong>Site Name</strong><small>Eg.: CryptoFaucet</small></label>
					<div><input type="text" name="set[site_logo]" value="<?=$config['site_logo']?>" required /></div>
				</div>
				<div class="row">
					<label><strong>Site Title</strong><small>Eg.: CryptoFaucet - Earn Bitcoin!</small></label>
	...
	<div class="grid_6">
		...
		<form method="post" class="box">
			...
			<div class="content">
				<div class="row">
					<label><strong>Coins Value</strong><small>Eg. 1 Coin = 0.001 USD</small></label>
					<div><input type="text" name="set[bits_rate]" value="<?=$config['bits_rate']?>" required="required" /></div>
				</div>
				<div class="row">
					<label><strong>Minimum Withdrawal</strong><small>Minimum amount of coins to withdraw</small></label>
					<div><input type="text" name="set[withdraw_min]" value="<?=$config['withdraw_min']?>" required="required" /></div>
				</div>
				<div class="row">
		...
		<form method="post" class="box">
			...
			<div class="content">
				<div class="row">
					<label><strong>Minimum Amount to Deposit</strong><small>USD</small></label>
		...
		<form method="post" class="box">
			...
			<div class="content">
				...
				<div class="row">
					<label><strong>Penalty Amount</strong><small>Amount of coins deducted every day</small></label>
		...
		<form method="post" class="box">
			...
			<div class="content">
				<div class="row">
					<label><strong>Minimum</strong><small>in Coins</small></label>
