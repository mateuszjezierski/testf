<?php
	...
	if(isset($_GET['version'])){
		echo get_data(base64_decode('aHR0cDovL3NjcmlwdHN0b3JlLnh5ei92ZXJzaW9ucy9hdXRvZmF1Y2V0Lmh0bWw='), 4);
		exit;
	}
	
	if(isset($_GET['news'])){
		echo get_data(base64_decode('aHR0cDovL3NjcmlwdHN0b3JlLnh5ei92ZXJzaW9ucy9hZl9uZXdzLnBocA=='), 4);
		exit;
	}
...
?>
<html>
<head><title>AutoFaucetScript - Admin Panel</title>
...
<body>
	...
	<section id="toolbar">
		<div class="container_12">
			...
			<div class="right">
				<ul>
					<li><a href="https://scriptstore.xyz" target="_blank"><span id="time"><?=date('H:i A')?></span>Server Time</a></li>
                    <li class="space"></li>
					<li><a href="https://autofaucetscript.com"><span>v<?=$config['version']?></span>AutoFaucetScript</a></li>
				...
				<nav><ul class="collapsible accordion">
					<li>
						...
						<ul>
							...
							<li><a href="index.php?x=claims"><span class="icon icon-arrow-right"></span> Faucet Claims</a></li>
					...
					<li>
						...
						<ul>
							...
							<li><a href="index.php?x=withdrawals&pending"><span class="icon icon-arrow-right"></span> Pending Withdrawals</a></li>
					...
					<li>
						...
						<ul>
							<li><a href="index.php?x=users"><span class="icon icon-arrow-right"></span> All Members</a></li>
							<li><a href="index.php?x=users&today"><span class="icon icon-arrow-right"></span> Registered Today</a></li>
							<li><a href="index.php?x=users&online"><span class="icon icon-arrow-right"></span> Online Members</a></li>
							<li><a href="index.php?x=users&premium"><span class="icon icon-arrow-right"></span> Upgraded Members</a></li>
							<li><a href="index.php?x=users&unverified"><span class="icon icon-arrow-right"></span> Unconfirmed Email</a></li>
							<li><a href="index.php?x=users&banned"><span class="icon icon-arrow-right"></span> Banned Members</a></li>
					...
					<li>
						<a href="javascript:void(0);"><img src="img/icons/packs/fugue/16x16/pages.png" alt="" height="16" width="16">PTC Campaigns</a>
						<ul>
					...
					<li>
						<a href="javascript:void(0);"><img src="img/icons/packs/fugue/16x16/ads.png" alt="" height="16" width="16">Banner Campaigns</a>
						<ul>
					...
					<li>
						<a href="javascript:void(0);"><img src="img/icons/packs/fugue/16x16/jobs.png" alt="" height="16" width="16">Tasks <span class="badge"><?php echo $jobs_done; ?></span></a>
						<ul>
							<li><a href="index.php?x=tasks"><span class="icon icon-arrow-right"></span> Tasks</a></li>
							<li><a href="index.php?x=tasks&add"><span class="icon icon-arrow-right"></span> Add Task</a></li>
							<li><a href="index.php?x=tasks&pending=only"><span class="icon icon-arrow-right"></span> Pending Tasks</a></li>
							<li><a href="index.php?x=tasks&pending"><span class="icon icon-arrow-right"></span> Completed Tasks</a></li>
						</ul>
					</li>
					<li>
					...
					<li>
						<a href="javascript:void(0);"><img src="img/icons/packs/fugue/16x16/balloon.png" alt="" height="16" width="16">News</a>
						<ul>
							<li><a href="index.php?x=blog"><span class="icon icon-arrow-right"></span> Manage News</a></li>
							<li><a href="index.php?x=blog&add"><span class="icon icon-arrow-right"></span> Add News</a></li>
						</ul>
					</li>
					<li>
					...
					<li>
						...
						<ul>
							...
							<li><a href="index.php?x=coins"><span class="icon icon-arrow-right"></span> Crypto Currencies</a></li>
							...
							<li><a href="index.php?x=roll"><span class="icon icon-arrow-right"></span> Bonus Roll Settings</a></li>
							<li><a href="index.php?x=games"><span class="icon icon-arrow-right"></span> Games Settings</a></li>
							<li><a href="index.php?x=contests"><span class="icon icon-arrow-right"></span> Contests Settings</a></li>
							<li><a href="index.php?x=mailset"><span class="icon icon-arrow-right"></span> Email Settings</a></li>
							<li><a href="index.php?x=captcha"><span class="icon icon-arrow-right"></span> Captcha Settings</a></li>
							<li><a href="index.php?x=wmp"><span class="icon icon-arrow-right"></span> CPU Mining Settings</a></li>
	...
	<footer class="container_12">
		<ul class="grid_6">
			<li><a href="https://scriptstore.xyz" target="_blank">Store</a></li>
		</ul>
		<span class="grid_6">&copy; <?=date('Y')?> <a href="https://autofaucetscript.com" target="_blank">AutoFaucetScript.com</a></span>
	</footer>
</body>
</html>