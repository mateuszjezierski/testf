<?php
	...
	// Banner System
	if(isset($_GET['go_banner']) && is_numeric($_GET['go_banner']) && isset($_GET['hash']) && $_GET['hash'] === $_SESSION['token']) {
	...
	*/
	...
	$pages = array(
			...
			'banners' => array(1, 1, 'pages/banners', 'Banner Ads'),
			'recover' => array(1, 0, 'pages/recover', 'Recover Password'),
			'tasks' => array(1, 1, 'pages/tasks', 'Jobs'),
			'faucet' => array(1, 1, 'pages/faucet', 'Auto Claim'),
			'manual' => array(1, 1, 'pages/manual', 'Manual Claim'),
			'roll' => array(1, 1, 'pages/roll', 'Bonus Roll'),
			'dice' => array(1, 1, 'pages/dice', 'Dice Game'),
			'flip' => array(1, 1, 'pages/flip', 'Coin Flip Game'),
			'scratch' => array(1, 1, 'pages/scratch', 'Scratch Ticket'),
