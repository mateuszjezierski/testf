...
{  
    ...
    public function extensionCheck($extensions=null) 
    {
        ...
        if (version_compare(phpversion(), '5.3', '<')) {
            ...
            $fail[] = 'You need<strong> PHP 5.3</strong> (or greater;<strong>Current Version:'.phpversion().')</strong>';
            //set error status for php version
            $fail_status[] = '<span class="label label-danger">Error</span>';
        } else {
            //set success message for php version
            $pass[] ='You have<strong> PHP 5.3</strong> (or greater; <strong>Current Version:'.phpversion().')</strong>';
        ...
        if (!ini_get('safe_mode')) {
            ...
            if (version_compare($match[0], '4.1', '<')) {
                //set error message if mysql version 
                $fail[] = 'You need<strong> MySQL 4.1</strong> (or greater; <strong>Current Version:.'.$match[0].')</strong>';
                //set error status for mysql version
                $fail_status[] = '<span class="label label-danger">Error</span>';
            } else {
                //set success message
                $pass[] ='You have<strong> MySQL 4.1</strong> (or greater; <strong>Current Version:'.$match[0].')</strong>';
                $pass_status[] = '<span class="label label-success">Success</span>';
            }
        ...
        echo "<table class='table table-bordered table-striped'>";
            ...
            if (isset($fail)){ 
                ...
                echo "<tr>";
                    echo "<td colspan='2'><div class='alert alert-success'><strong>Congratulations!</strong> Your server meets the requirements to install this script.</td>";
                echo "</tr>";
